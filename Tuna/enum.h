...
enum EndstopEnum : uint8_t {
  ...
  enum AdvancedPauseMenuResponse : uint8_t {
    ...
    enum AdvancedPauseMessage : uint8_t {
 ...
 */
  ...
  enum WorkspacePlane : uint8_t { PLANE_XY, PLANE_ZX, PLANE_YZ };
#endif
